...
function CalligraphyContemporaryContent() {
    ...
    useEffect(() => {
        const fetchArtworks = async () => {
            try {
                const response = await fetch('/api/admin/products?collection=calligraphy-contemporary&is_active=true');
                if (!response.ok) {
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-white">Calligraphy & Contemporary</h1>
                <div className="mb-12">
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-6">
                {filteredArtworks.map(artwork => (
                    ...
                    >
                        {/* <Link
                            href={`/art/calligraphy-contemporary/${artwork.id}`}
...
export default function Calligraphy_Contemporary() {
    return (
        <Suspense fallback={
            <div className="container mx-auto px-4 py-12">
            ...
            <CalligraphyContemporaryContent />
        </Suspense>
    );
} 