    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-white">Asian Landscapes</h1>
                <div className="mb-12">
...
export default function AsianLandscapes() {
    return (
        <Suspense fallback={
            <div className="container mx-auto px-4 py-12">
