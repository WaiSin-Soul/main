...
function WesternLandscapesSeascapesContent() {
    ...
    useEffect(() => {
        const fetchArtworks = async () => {
            try {
                const response = await fetch('/api/admin/products?collection=western-landscapes-seascapes&is_active=true');
                if (!response.ok) {
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-white">Western Landscapes + Seascapes</h1>
                <div className="mb-12">
...
export default function WesternLandscapesSeascapes() {
    return (
        <Suspense fallback={
            <div className="container mx-auto px-4 py-12">
            ...
            <WesternLandscapesSeascapesContent />
        </Suspense>
    );
}
