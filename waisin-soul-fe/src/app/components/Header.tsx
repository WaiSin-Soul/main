    ...
    return (
        <header className="flex justify-between items-center p-5 bg-header text-white relative">
            ...
            <div className="flex space-x-6 pr-5">
                <button className="hover:underline" onClick={toggleSearch}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"/></svg></button>
            ...
            {isSearchOpen && (
                <div className="absolute top-16 left-0 right-0 bg-white p-4 shadow-lg z-20">
