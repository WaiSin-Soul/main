...
export const productsDatabase: Record<string, Product> = {
  'seeking-knowledge-laptop': {
    ...
    description: 'Premium laptop sleeve featuring the SEEKING KNOWLEDGE artwork',
    basePrice: 45,
    image: '/images/feature1.webp',
    collection: 'products',
    details: 'High-quality laptop protection with artistic design. Perfect for creative professionals.',
    materials: [
      { id: 'mat-1', name: 'Lustre Photo Paper', type: 'material', value: 'lustre-photo' },
      { id: 'mat-2', name: 'Watercolor Fine Art Paper II', type: 'material', value: 'watercolor-ii' },
      { id: 'mat-3', name: 'Smooth Fine Art Paper III', type: 'material', value: 'smooth-iii' },
      { id: 'mat-4', name: 'Textured Fine Art Paper', type: 'material', value: 'textured' },
      { id: 'mat-5', name: 'High Gloss Metallic', type: 'material', value: 'gloss-metallic' },
    ],
    sizes: [
    ...
    styles: [
      { id: 'style-1', name: 'Just the Print - Borderless', type: 'style', value: 'borderless' },
      { id: 'style-2', name: 'Print with Frame', type: 'style', value: 'framed', price: 25 },
      { id: 'style-3', name: 'Canvas Wrap', type: 'style', value: 'canvas', price: 35 },
    ],
  },
  'serenity-laptop': {
    id: 'serenity-laptop',
...
export const artPiecesDatabase: Record<string, Product> = {
  'best-seller-1': {
    ...
    sizes: [
      ...
      { id: 'size-2', name: '16 x 20', type: 'size', value: '16x20', price: 50 },
      { id: 'size-3', name: '24 x 36', type: 'size', value: '24x36', price: 100 },
    ],
    styles: [
      { id: 'style-1', name: 'Print Only', type: 'style', value: 'print' },
      { id: 'style-2', name: 'Framed', type: 'style', value: 'framed', price: 75 },
    ],
  },
  'best-seller-2': {
    id: 'best-seller-2',
  ...
  'landscape-1': {
    ...
    basePrice: 249.99,
    image: '/images/feature1.webp',
    details: 'Beautiful landscape artwork with vibrant colors. Perfect for nature lovers.',
